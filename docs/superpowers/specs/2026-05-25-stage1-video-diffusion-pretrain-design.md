...
- SDS supervision: SVD provides gradient signal for plausible motion
...
│   │   └── gen_video.py    # SVD motion video generation
...
5. Set up SVD pipeline for motion video generation
...
| Risk | Mitigation |
|------|-----------|
| SVD-generated videos not physically plausible | Use SDS to constrain simulation, not raw SVD output as GT |
...
2. SVD produces motion videos that look like plant deformation
